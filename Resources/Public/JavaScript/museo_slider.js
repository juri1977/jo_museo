...
function initSlider() {
    ...
    function customTooltip(tooltipModel) {
        ...
        if (tooltipModel.body) {
            ...
            strNewUrl += "&" + extbase_config.starttime + parseInt(tmpTitle);
            strNewUrl += "&" + extbase_config.endtime + parseInt(tmpTitle);


            var innerHtml = '<a href="' + strNewUrl +'"><span>';
            innerHtml += tmpTitle;
            innerHtml += ' - </span>';
            ...
            innerHtml += ' Einträge</span></a>';

            /*
	        var link = ' <a href="' + strNewUrl +'">Link</a>';
